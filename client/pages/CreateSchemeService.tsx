...
export default function CreateSchemeService() {
  ...
  const [processSteps, setProcessSteps] = useState<
    { slNo: string; stepDetails: string }[]
  >([]);
  const [documents, setDocuments] = useState<
    { slNo: string; documentType: string; validProof: string }[]
  >([]);
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-xl font-bold">Create New Scheme Service</span>
            </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide the essential details about your scheme service
              </CardDescription>
            </CardHeader>
          ...
          <div className="flex justify-end space-x-4">
            <Button
              type="button"
              variant="outline"
              onClick={() => navigate("/scheme-service")}
            >
              Cancel
            </Button>
