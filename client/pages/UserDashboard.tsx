  ...
  const services = [
    {
      ...
      summary: "Quick insights for your business online with no Hassle.",
      applicationMode: "Online",
      eligibility: "All registered users",
      status: "active",
      views: 123,
      provider: "DataPro Analytics",
    },
    {
      id: 2,
      name: "Technical Documentation",
      summary: "Professional technical writing and documentation services",
      applicationMode: "Offline",
      eligibility: "Businesses only",
      status: "active",
      views: 87,
      provider: "TechWrite Solutions",
    },
  ];
