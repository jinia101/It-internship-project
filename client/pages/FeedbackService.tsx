        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Manage and review all feedback services and their details here.
            </p>
          </div>
            ...
            <TabsContent value="create" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Add a new feedback service to the platform
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-medium mb-2">
                      Ready to create a new feedback service?
                    </h3>
                    ...
                    <Button size="lg" asChild>
                      <Link to="/admin/create-feedback-service">
                        Create New Service
            ...
            <TabsContent value="pending" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Review and approve submitted feedback services
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="published" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage your live feedback services and monitor performance
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
