...
export default function CreateFeedbackService() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      saveService({
        ...
        status: "pending",
        processNew: formData.processNew,
        processUpdate: formData.processUpdate,
        processLost: formData.processLost,
        processSurrender: formData.processSurrender,
        docNew: formData.docNew,
        docUpdate: formData.docUpdate,
        docLost: formData.docLost,
        docSurrender: formData.docSurrender,
